/*global MAQ,document*/
/// <reference path="MAQ.Utils.min.js"/>
/** 
* This file handles logic generating pager inside an array of HTML container objects, or an HTML element id
*/
if (typeof MAQ === "undefined" || typeof MAQ.Utils === "undefined") {
	throw "Please load MAQ.Utils.js first";
}
...
MAQ.Pager = (function () {
	...
	U = MAQ.Utils, // Shorthand for MAQ.Utils
	...
	_GetPager = function (oConfig) {
		...
		_ParsePagerFormat = function (sFormat) {
			var oPlaceHolders = sFormat.match(/{([^}]+)}/gi),
				rPlaceHolderWithAttrs = /\{(\w+?)\[(.+[^\]])\]\}/gi,
				rPlaceHolder = /\{(\w+)\}/gi,
				i = 0;
		...
		// TODO: Move these functions out of this file and add one more parameter as MAQ.Pager object, so anyone can add any type of placeholder and can override anyone of these
